...
| Frontend tests                                                          | `references/frontend-testing-policy.md` and the accepted product journeys                                                            |
| Nest modules, controllers, providers, feature structure                 | `references/backend-nestjs-policy.md`                                                                                                |
| Backend unit, adapter, or HTTP tests                                    | `references/nestjs-testing-policy.md`                                                                                                |
