...
- [ ] T004 [P] [US1] Extend `apps/web/src/modules/scans/ui/scans-panel.test.tsx` with a request counter proving one automatic request on opening, announced preparation, retained metadata, and unchanged Print and Download actions (FR-001–FR-002, FR-005–FR-006, FR-013; SC-001, SC-009)
...
- [ ] T006 [P] [US1] Create `apps/web/src/modules/scans/ui/scan-preview-experience.test.tsx` with a mocked renderer facade proving ready-state announcement, one-row icon-only controls, and exact forwarding of rotate left/right, zoom in/out, and reset from accessible names (FR-005–FR-006, FR-011; SC-005, SC-008)
...
- [ ] T008 [US1] Implement the automatic deferred boundary in `apps/web/src/modules/scans/ui/scan-preview.tsx`, mounting `scan-preview-experience.tsx` through React lazy/Suspense as soon as scan details open (FR-001–FR-002, FR-005, FR-012; SC-001, SC-003)
...
- [ ] T014 [US2] Complete close and failure cleanup across `scan-preview.tsx`, `scan-preview-experience.tsx`, and `scan-preview-renderer.ts`, ensuring an aborted or late asynchronous result cannot recreate a renderer and reopening starts one new preparing attempt (FR-010, FR-012; SC-007, SC-010)
...
- [ ] T015 Extend `apps/web/src/modules/scans/ui/scans-panel.test.tsx` with final preview/Download/Print non-regression, icon-only controls, removed privacy copy, and compact gesture-boundary assertions, preserving existing tests rather than replacing them (FR-011, FR-013; SC-005, SC-009)
