...
- [x] CHK049 Adjacent-page failure presents neither provisional nor previous-page rows as the requested page and offers a localized, accessible blocking retry across all three collections. [Spec US2-AS10, US3-AS14, US4-AS14, FR-057, SC-017]
